...
class Maison1EditType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('surface', IntegerType::class, [
            ...
            ->add('facade', ChoiceType::class, [
                ...
                'label' => 'Façade (facultatif)',
                'placeholder' => 'Façade (facultatif)',
                'required' => false,
                'expanded' => true,
                'multiple' => true
            ])
            ->add('toiture', ChoiceType::class, [
                'choices' => [
                    'Zinc' => 'Zinc', 'Tuiles' => 'Tuiles',
                    'Ardoise' => 'Ardoise', 'Chaume' => 'Chaume',
                    'Toit terrasse' => 'Toit terrasse', 'Autre' => 'Autre',
                ],
                'choice_attr' => function($choice, $key, $value) {
                    return ['class' => 'form-check-input filled-in'];
                },
                'label' => 'Toiture (facultatif)',
                'placeholder' => 'Toiture (facultatif)',
                'required' => false,
                'expanded' => true,
                'multiple' => true
            ])
