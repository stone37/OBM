...
class IpadEtTablettesEditType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('brand', ChoiceType::class, [
                'choices' => [
                    'Apple' => 'Apple', 'Asus' => 'Asus', 'Samsung' => 'Samsung',
                    'Acer' => 'Acer', 'Blackberry' => 'Blackberry', 'Microsoft' => 'Microsoft',
                    'Itel' => 'Itel', 'Techno' => 'Techno', 'Google' => 'Google',
                    'Sony' => 'Sony', 'Toshiba' => 'Toshiba', 'HP' => 'HP', 'Lenovo' => 'Lenovo',
                    'Motorola' => 'Motorola', 'Huawei' => 'Huawei', 'HTC' => 'HTC', 'Autre' => 'Autre',
                ],
                'label' => 'Marque',
                'attr' => [
