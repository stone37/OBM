...
class ThreadRepository extends ServiceEntityRepository
{
    ...
    public function getParticipantInboxThreads(User $user)
    {
    ...
    public function getParticipantSentThreads(User $user)
    {
        $qb = $this->createQueryBuilder('t')
            ->innerJoin('t.metadata', 'tm')
            ->innerJoin('tm.participant', 'p')
    ...
    public function getParticipantDeletedThreads(User $user)
    {
        $qb = $this->createQueryBuilder('t')
            ->innerJoin('t.metadata', 'tm')
            ->innerJoin('tm.participant', 'p')
    ...
    public function getThreadsCreatedBy(User $user)
    {
        $qb = $this->createQueryBuilder('t')
    ...
    public function getThreadsCreatedByAdvert(Advert $advert, User $user)
    {
        $qb = $this->createQueryBuilder('t')
            ->select('count(t.id)')
    ...
    public function getParticipantThreads(User $user)
    {
        $qb = $this->createQueryBuilder('t')
            ->innerJoin('t.metadata', 'tm')
            ->innerJoin('tm.participant', 'p')
